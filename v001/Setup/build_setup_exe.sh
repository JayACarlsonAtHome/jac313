...
# glibc versions, and at C++23. Re-run this and commit Setup/jac313_setup whenever the
# Setup library or its recipe handling changes.
#
# Usage:  cd v001 && ./Setup/build_setup_exe.sh
set -eu
