// Unit tests for the in-tree jac313::Qlite::v001 SQLite wrapper.
...
static_assert(jac313::Qlite::v001::version() == "v001.001", "v001 version");
...
int main() {
    ...
    if (failures == 0) {
        std::cout << "jac313::Qlite::v001 — all CRUD/transaction/error tests passed\n";
        return 0;
    }
