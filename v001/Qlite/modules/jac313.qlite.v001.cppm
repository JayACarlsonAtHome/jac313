...
// jac313.qlite.v001 — module interface over the shared implementation body
// (Sqlite.body.hpp). Both build configurations export the SAME public API under
// `jac313::Qlite::v001` (matching the textual header and the jText/store packages);
...
// namespace, diverging from the header's `jac313::Qlite::v001::` spelling.
...
export namespace jac313::Qlite::v001 {
