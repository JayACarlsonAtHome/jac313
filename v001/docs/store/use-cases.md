...
```cpp
using Cfg = jac313::Store::v001::ts_store_config<true, 6, 20, 43, 0, 3, false>;
jac313::Store::v001::ts_store<Cfg> store(threads, events_per_thread);
...
```cpp
using Cfg = jac313::Store::v001::ts_store_config<true, 6, 20, 43, 0, 2, false>;
...
```cpp
using Cfg = jac313::Store::v001::ts_store_config<true, 6, 20, 80, 0, 0, false>;
...
```cpp
using Cfg = jac313::Store::v001::ts_store_config<true, 6, 20, 43, 0, 9, false>;
...
```cpp
using Cfg = jac313::Store::v001::ts_store_config<true, 6, 20, 43, 0, 1, false>;
