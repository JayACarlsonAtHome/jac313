...
| Skipped | 0 |
| Errors | 0 |
| Duration | 17,686 ms (17s) |
| Build straight (no modules) | 15,839 ms (15,839 ms (15s)) |
| Build modules only | 1,755 ms (1,755 ms (1s)) |
| Build with modules (rest) | 16,193 ms (16,193 ms (16s)) |
...
|------|--------|---------|--------|--------------|----------|
| jac313_store_005_TS | off | binary | 150 | 749,064 | 85.80 KiB |
|  |  | jtext | 50 | 742,942 | 75.93 KiB |
|  |  | sql | 50 | 1,157,407 | 88.00 KiB |
| jac313_store_005_TS | on | binary | 100 | 1,109,878 | 85.80 KiB |
|  |  | jtext | 50 | 874,891 | 75.90 KiB |
|  |  | sql | 50 | 735,294 | 88.00 KiB |
| jac313_store_005_XS | off | binary | 100 | 515,996 | 85.80 KiB |
|  |  | jtext | 50 | 851,789 | 73.85 KiB |
|  |  | sql | 50 | 1,582,278 | 84.00 KiB |
| jac313_store_005_XS | on | binary | 100 | 799,361 | 85.80 KiB |
|  |  | jtext | 50 | 580,720 | 73.85 KiB |
|  |  | sql | 50 | 881,834 | 84.00 KiB |
...
| jac313_store_007_TS | off | binary | 100 | 1,265,823 | 202.99 KiB |
|  |  | jtext | 50 | 1,084,599 | 181.42 KiB |
|  |  | sql | 50 | 1,132,503 | 256.00 KiB |
| jac313_store_007_TS | on | binary | 100 | 1,422,475 | 202.99 KiB |
|  |  | jtext | 50 | 1,021,450 | 181.42 KiB |
|  |  | sql | 50 | 1,275,510 | 256.00 KiB |
| jac313_store_007_XS | off | binary | 100 | 734,214 | 202.99 KiB |
|  |  | jtext | 50 | 1,179,245 | 179.47 KiB |
|  |  | sql | 50 | 1,592,357 | 248.00 KiB |
| jac313_store_007_XS | on | binary | 100 | 722,543 | 202.99 KiB |
|  |  | jtext | 50 | 894,454 | 179.47 KiB |
|  |  | sql | 50 | 664,011 | 248.00 KiB |
...
| jac313_store_003_TS | store | matrix | jtext | off | pass | 351 | - | 181.42 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_003_TS/clang_jtext_off.log) |
...
| jac313_store_003_XS | store | matrix | jtext | on | pass | 351 | - | 179.47 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_003_XS/clang_jtext_on.log) |
...
| jac313_store_005_TS | store | matrix | binary | off | pass | 150 | 749,064 | 85.80 KiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_005_TS/clang_binary_off.log) |
| jac313_store_005_TS | store | matrix | binary | on | pass | 100 | 1,109,878 | 85.80 KiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_005_TS/clang_binary_on.log) |
| jac313_store_005_TS | store | matrix | jtext | off | pass | 50 | 742,942 | 75.93 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_TS/clang_jtext_off.log) |
| jac313_store_005_TS | store | matrix | jtext | on | pass | 50 | 874,891 | 75.90 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_TS/clang_jtext_on.log) |
| jac313_store_005_TS | store | matrix | none | off | pass | 50 | 543,183 | - | - | [clang_none_off.log](inmem_logs/JAC313_STORE_TEST_005_TS/clang_none_off.log) |
| jac313_store_005_TS | store | matrix | none | on | pass | 50 | 2,127,660 | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_005_TS/clang_none_on.log) |
| jac313_store_005_TS | store | matrix | sql | off | pass | 50 | 1,157,407 | 88.00 KiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_005_TS/clang_sql_off.log) |
| jac313_store_005_TS | store | matrix | sql | on | pass | 50 | 735,294 | 88.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_005_TS/clang_sql_on.log) |
| jac313_store_005_XS | store | matrix | binary | off | pass | 100 | 515,996 | 85.80 KiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_005_XS/clang_binary_off.log) |
| jac313_store_005_XS | store | matrix | binary | on | pass | 100 | 799,361 | 85.80 KiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_005_XS/clang_binary_on.log) |
| jac313_store_005_XS | store | matrix | jtext | off | pass | 50 | 851,789 | 73.85 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_XS/clang_jtext_off.log) |
| jac313_store_005_XS | store | matrix | jtext | on | pass | 50 | 580,720 | 73.85 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_XS/clang_jtext_on.log) |
| jac313_store_005_XS | store | matrix | none | off | pass | 50 | 2,192,982 | - | - | [clang_none_off.log](inmem_logs/JAC313_STORE_TEST_005_XS/clang_none_off.log) |
| jac313_store_005_XS | store | matrix | none | on | pass | 50 | 1,270,648 | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_005_XS/clang_none_on.log) |
| jac313_store_005_XS | store | matrix | sql | off | pass | 50 | 1,582,278 | 84.00 KiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_005_XS/clang_sql_off.log) |
| jac313_store_005_XS | store | matrix | sql | on | pass | 50 | 881,834 | 84.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_005_XS/clang_sql_on.log) |
...
| jac313_store_006_XS | store | matrix | jtext | on | pass | 401 | N/A | 179.47 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_006_XS/clang_jtext_on.log) |
...
| jac313_store_007_TS | store | matrix | binary | off | pass | 100 | 1,265,823 | 202.99 KiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_007_TS/clang_binary_off.log) |
| jac313_store_007_TS | store | matrix | binary | on | pass | 100 | 1,422,475 | 202.99 KiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_007_TS/clang_binary_on.log) |
| jac313_store_007_TS | store | matrix | jtext | off | pass | 50 | 1,084,599 | 181.42 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_TS/clang_jtext_off.log) |
| jac313_store_007_TS | store | matrix | jtext | on | pass | 50 | 1,021,450 | 181.42 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_TS/clang_jtext_on.log) |
| jac313_store_007_TS | store | matrix | none | off | pass | 50 | 952,381 | - | - | [clang_none_off.log](inmem_logs/JAC313_STORE_TEST_007_TS/clang_none_off.log) |
| jac313_store_007_TS | store | matrix | none | on | pass | 50 | 962,464 | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_007_TS/clang_none_on.log) |
| jac313_store_007_TS | store | matrix | sql | off | pass | 50 | 1,132,503 | 256.00 KiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_007_TS/clang_sql_off.log) |
| jac313_store_007_TS | store | matrix | sql | on | pass | 50 | 1,275,510 | 256.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_007_TS/clang_sql_on.log) |
| jac313_store_007_XS | store | matrix | binary | off | pass | 100 | 734,214 | 202.99 KiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_007_XS/clang_binary_off.log) |
| jac313_store_007_XS | store | matrix | binary | on | pass | 100 | 722,543 | 202.99 KiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_007_XS/clang_binary_on.log) |
| jac313_store_007_XS | store | matrix | jtext | off | pass | 50 | 1,179,245 | 179.47 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_XS/clang_jtext_off.log) |
| jac313_store_007_XS | store | matrix | jtext | on | pass | 50 | 894,454 | 179.47 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_XS/clang_jtext_on.log) |
| jac313_store_007_XS | store | matrix | none | off | pass | 50 | 1,964,637 | - | - | [clang_none_off.log](inmem_logs/JAC313_STORE_TEST_007_XS/clang_none_off.log) |
| jac313_store_007_XS | store | matrix | none | on | pass | 50 | 2,012,072 | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_007_XS/clang_none_on.log) |
| jac313_store_007_XS | store | matrix | sql | off | pass | 50 | 1,592,357 | 248.00 KiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_007_XS/clang_sql_off.log) |
| jac313_store_007_XS | store | matrix | sql | on | pass | 50 | 664,011 | 248.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_007_XS/clang_sql_on.log) |
| jac313_store_008_TS | store | matrix | flags | off | pass | 150 | 1,113,586 | - | - | [clang_flags_off.log](flags_logs/JAC313_STORE_TEST_008_TS/clang_flags_off.log) |
| jac313_store_008_XS | store | matrix | flags | off | pass | 50 | 597,729 | - | - | [clang_flags_off.log](flags_logs/JAC313_STORE_TEST_008_XS/clang_flags_off.log) |
