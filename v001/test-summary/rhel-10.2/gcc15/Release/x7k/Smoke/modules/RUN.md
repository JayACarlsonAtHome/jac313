...
| Skipped | 0 |
| Errors | 0 |
| Duration | 17,534 ms (17s) |
| Build straight (no modules) | 16,699 ms (16,699 ms (16s)) |
| Build modules only | 1,604 ms (1,604 ms (1s)) |
| Build with modules (rest) | 17,151 ms (17,151 ms (17s)) |
| Build modules only (import std) | 6,014 ms (6,014 ms (6s)) |
| Build with modules (import std) | 17,049 ms (17,049 ms (17s)) |
| import std vs textual modules | -102 ms (0% faster) |
| Peak ops/sec | 2,277,904 |
...
|------|--------|---------|--------|--------------|----------|
| jac313_store_005_TS | off | binary | 100 | 747,943 | 85.80 KiB |
|  |  | jtext | 50 | 1,623,377 | 75.80 KiB |
|  |  | sql | 50 | 898,473 | 84.00 KiB |
| jac313_store_005_TS | on | binary | 100 | 954,198 | 85.80 KiB |
|  |  | jtext | 50 | 1,138,952 | 75.80 KiB |
|  |  | sql | 50 | 1,101,322 | 84.00 KiB |
| jac313_store_005_XS | off | binary | 100 | 801,282 | 85.80 KiB |
|  |  | jtext | 50 | 907,441 | 73.85 KiB |
|  |  | sql | 50 | 1,121,076 | 84.00 KiB |
| jac313_store_005_XS | on | binary | 100 | 1,398,601 | 85.80 KiB |
|  |  | jtext | 50 | 1,228,501 | 73.85 KiB |
|  |  | sql | 50 | 810,373 | 84.00 KiB |
...
|  |  | jtext | 351 | N/A | 179.47 KiB |
|  |  | sql | 351 | N/A | 248.00 KiB |
| jac313_store_007_TS | off | binary | 100 | 794,281 | 202.99 KiB |
|  |  | jtext | 50 | 1,331,558 | 181.57 KiB |
|  |  | sql | 50 | 1,426,534 | 256.00 KiB |
| jac313_store_007_TS | on | binary | 100 | 1,438,849 | 202.99 KiB |
|  |  | jtext | 50 | 1,013,171 | 181.61 KiB |
|  |  | sql | 50 | 621,504 | 256.00 KiB |
| jac313_store_007_XS | off | binary | 100 | 970,874 | 202.99 KiB |
|  |  | jtext | 50 | 828,500 | 179.47 KiB |
|  |  | sql | 50 | 1,600,000 | 248.00 KiB |
| jac313_store_007_XS | on | binary | 100 | 970,874 | 202.99 KiB |
|  |  | jtext | 50 | 900,901 | 179.47 KiB |
|  |  | sql | 50 | 1,118,568 | 248.00 KiB |
...
| jac313_store_003_TS | store | matrix | jtext | on | pass | 401 | - | 181.52 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_003_TS/gcc15_jtext_on.log) |
...
| jac313_store_003_XS | store | matrix | jtext | on | pass | 351 | - | 179.47 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_003_XS/gcc15_jtext_on.log) |
...
| jac313_store_004_TS | store | matrix | jtext | off | pass | 50 | - | 20.61 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_004_TS/gcc15_jtext_off.log) |
...
| jac313_store_005_TS | store | matrix | binary | off | pass | 100 | 747,943 | 85.80 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_005_TS/gcc15_binary_off.log) |
| jac313_store_005_TS | store | matrix | binary | on | pass | 100 | 954,198 | 85.80 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_005_TS/gcc15_binary_on.log) |
| jac313_store_005_TS | store | matrix | jtext | off | pass | 50 | 1,623,377 | 75.80 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_TS/gcc15_jtext_off.log) |
| jac313_store_005_TS | store | matrix | jtext | on | pass | 50 | 1,138,952 | 75.80 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_TS/gcc15_jtext_on.log) |
| jac313_store_005_TS | store | matrix | none | off | pass | 50 | 1,443,001 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_005_TS/gcc15_none_off.log) |
| jac313_store_005_TS | store | matrix | none | on | pass | 50 | 511,509 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_005_TS/gcc15_none_on.log) |
| jac313_store_005_TS | store | matrix | sql | off | pass | 50 | 898,473 | 84.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_005_TS/gcc15_sql_off.log) |
| jac313_store_005_TS | store | matrix | sql | on | pass | 50 | 1,101,322 | 84.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_005_TS/gcc15_sql_on.log) |
| jac313_store_005_XS | store | matrix | binary | off | pass | 100 | 801,282 | 85.80 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_005_XS/gcc15_binary_off.log) |
| jac313_store_005_XS | store | matrix | binary | on | pass | 100 | 1,398,601 | 85.80 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_005_XS/gcc15_binary_on.log) |
| jac313_store_005_XS | store | matrix | jtext | off | pass | 50 | 907,441 | 73.85 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_XS/gcc15_jtext_off.log) |
| jac313_store_005_XS | store | matrix | jtext | on | pass | 50 | 1,228,501 | 73.85 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_XS/gcc15_jtext_on.log) |
| jac313_store_005_XS | store | matrix | none | off | pass | 50 | 1,533,742 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_005_XS/gcc15_none_off.log) |
| jac313_store_005_XS | store | matrix | none | on | pass | 50 | 1,201,923 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_005_XS/gcc15_none_on.log) |
| jac313_store_005_XS | store | matrix | sql | off | pass | 50 | 1,121,076 | 84.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_005_XS/gcc15_sql_off.log) |
| jac313_store_005_XS | store | matrix | sql | on | pass | 50 | 810,373 | 84.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_005_XS/gcc15_sql_on.log) |
...
| jac313_store_006_TS | store | matrix | jtext | off | pass | 351 | N/A | 181.45 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_006_TS/gcc15_jtext_off.log) |
| jac313_store_006_TS | store | matrix | jtext | on | pass | 401 | N/A | 181.50 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_006_TS/gcc15_jtext_on.log) |
...
| jac313_store_007_TS | store | matrix | binary | off | pass | 100 | 794,281 | 202.99 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_007_TS/gcc15_binary_off.log) |
| jac313_store_007_TS | store | matrix | binary | on | pass | 100 | 1,438,849 | 202.99 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_007_TS/gcc15_binary_on.log) |
| jac313_store_007_TS | store | matrix | jtext | off | pass | 50 | 1,331,558 | 181.57 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_TS/gcc15_jtext_off.log) |
| jac313_store_007_TS | store | matrix | jtext | on | pass | 50 | 1,013,171 | 181.61 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_TS/gcc15_jtext_on.log) |
| jac313_store_007_TS | store | matrix | none | off | pass | 50 | 2,277,904 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_007_TS/gcc15_none_off.log) |
| jac313_store_007_TS | store | matrix | none | on | pass | 50 | 2,127,660 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_007_TS/gcc15_none_on.log) |
| jac313_store_007_TS | store | matrix | sql | off | pass | 50 | 1,426,534 | 256.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_007_TS/gcc15_sql_off.log) |
| jac313_store_007_TS | store | matrix | sql | on | pass | 50 | 621,504 | 256.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_007_TS/gcc15_sql_on.log) |
| jac313_store_007_XS | store | matrix | binary | off | pass | 100 | 970,874 | 202.99 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_007_XS/gcc15_binary_off.log) |
| jac313_store_007_XS | store | matrix | binary | on | pass | 100 | 970,874 | 202.99 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_007_XS/gcc15_binary_on.log) |
| jac313_store_007_XS | store | matrix | jtext | off | pass | 50 | 828,500 | 179.47 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_XS/gcc15_jtext_off.log) |
| jac313_store_007_XS | store | matrix | jtext | on | pass | 50 | 900,901 | 179.47 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_XS/gcc15_jtext_on.log) |
| jac313_store_007_XS | store | matrix | none | off | pass | 50 | 1,402,525 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_007_XS/gcc15_none_off.log) |
| jac313_store_007_XS | store | matrix | none | on | pass | 50 | 1,127,396 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_007_XS/gcc15_none_on.log) |
| jac313_store_007_XS | store | matrix | sql | off | pass | 50 | 1,600,000 | 248.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_007_XS/gcc15_sql_off.log) |
| jac313_store_007_XS | store | matrix | sql | on | pass | 50 | 1,118,568 | 248.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_007_XS/gcc15_sql_on.log) |
| jac313_store_008_TS | store | matrix | flags | off | pass | 150 | 1,386,963 | - | - | [gcc15_flags_off.log](flags_logs/JAC313_STORE_TEST_008_TS/gcc15_flags_off.log) |
| jac313_store_008_XS | store | matrix | flags | off | pass | 100 | 580,720 | - | - | [gcc15_flags_off.log](flags_logs/JAC313_STORE_TEST_008_XS/gcc15_flags_off.log) |
