...
| jac313_store_006_TS | on | binary | 35,405 | - | 19.81 MiB |
|  |  | jtext | 35,398 | - | 20.37 MiB |
|  |  | sql | 35,701 | - | 23.50 MiB |
| jac313_store_006_XS | off | binary | 31,281 | - | 19.81 MiB |
|  |  | jtext | 31,281 | - | 19.96 MiB |
|  |  | sql | 31,232 | - | 22.64 MiB |
| jac313_store_006_XS | on | binary | 34,498 | - | 19.81 MiB |
|  |  | jtext | 34,494 | - | 19.96 MiB |
|  |  | sql | 34,745 | - | 22.64 MiB |
...
| jac313_store_006_TS | store | matrix | binary | off | pass | 31,836 | - | 19.81 MiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_006_TS/clang_binary_off.log) |
| jac313_store_006_TS | store | matrix | binary | on | pass | 35,405 | - | 19.81 MiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_006_TS/clang_binary_on.log) |
...
| jac313_store_006_TS | store | matrix | jtext | on | pass | 35,398 | - | 20.37 MiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_006_TS/clang_jtext_on.log) |
| jac313_store_006_TS | store | matrix | none | off | pass | 31,688 | - | - | - | [clang_none_off.log](inmem_logs/JAC313_STORE_TEST_006_TS/clang_none_off.log) |
| jac313_store_006_TS | store | matrix | none | on | pass | 35,300 | - | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_006_TS/clang_none_on.log) |
| jac313_store_006_TS | store | matrix | sql | off | pass | 31,834 | - | 23.50 MiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_006_TS/clang_sql_off.log) |
| jac313_store_006_TS | store | matrix | sql | on | pass | 35,701 | - | 23.50 MiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_006_TS/clang_sql_on.log) |
...
| jac313_store_006_XS | store | matrix | binary | on | pass | 34,498 | - | 19.81 MiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_006_XS/clang_binary_on.log) |
...
| jac313_store_006_XS | store | matrix | none | on | pass | 34,342 | - | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_006_XS/clang_none_on.log) |
| jac313_store_006_XS | store | matrix | sql | off | pass | 31,232 | - | 22.64 MiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_006_XS/clang_sql_off.log) |
| jac313_store_006_XS | store | matrix | sql | on | pass | 34,745 | - | 22.64 MiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_006_XS/clang_sql_on.log) |
