...
|  |  | sql | 351 | - | 256.00 KiB |
| jac313_store_006_TS | on | binary | 403 | - | 202.98 KiB |
...
| jac313_store_006_TS | store | matrix | binary | off | pass | 403 | - | 202.98 KiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_006_TS/clang_binary_off.log) |
| jac313_store_006_TS | store | matrix | binary | on | pass | 403 | - | 202.98 KiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_006_TS/clang_binary_on.log) |
...
| jac313_store_006_XS | store | matrix | jtext | on | pass | 401 | - | 179.40 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_006_XS/clang_jtext_on.log) |
...
| jac313_store_006_XS | store | matrix | sql | on | pass | 856 | - | 248.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_006_XS/clang_sql_on.log) |
