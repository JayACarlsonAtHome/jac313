...
| Skipped | 0 |
| Errors | 0 |
| Duration | 15,938 ms (15s) |
| Build straight (no modules) | 13,275 ms (13,275 ms (13s)) |
| Build modules only | 5,617 ms (5,617 ms (5s)) |
| Build with modules (rest) | 12,134 ms (12,134 ms (12s)) |
| Peak ops/sec | 768,049 |
...
|------|--------|---------|--------|--------------|----------|
| jac313_store_005_TS | off | binary | 50 | 362,188 | 85.80 KiB |
|  |  | jtext | 50 | 363,769 | 76.72 KiB |
|  |  | sql | 50 | 364,964 | 84.00 KiB |
| jac313_store_005_TS | on | binary | 50 | 342,700 | 85.80 KiB |
|  |  | jtext | 50 | 327,976 | 76.73 KiB |
|  |  | sql | 50 | 337,724 | 84.00 KiB |
| jac313_store_005_XS | off | binary | 50 | 312,891 | 85.80 KiB |
|  |  | jtext | 50 | 348,432 | 73.80 KiB |
|  |  | sql | 50 | 356,379 | 84.00 KiB |
| jac313_store_005_XS | on | binary | 50 | 342,349 | 85.80 KiB |
|  |  | jtext | 50 | 344,828 | 73.80 KiB |
|  |  | sql | 50 | 377,501 | 84.00 KiB |
...
|  |  | sql | 351 | - | 248.00 KiB |
| jac313_store_007_TS | off | binary | 50 | 341,997 | 202.98 KiB |
|  |  | jtext | 50 | 360,620 | 182.33 KiB |
|  |  | sql | 50 | 322,373 | 252.00 KiB |
| jac313_store_007_TS | on | binary | 50 | 340,020 | 202.98 KiB |
|  |  | jtext | 50 | 355,619 | 182.33 KiB |
|  |  | sql | 50 | 378,931 | 252.00 KiB |
| jac313_store_007_XS | off | binary | 50 | 351,124 | 202.98 KiB |
|  |  | jtext | 50 | 377,929 | 179.40 KiB |
|  |  | sql | 50 | 363,769 | 248.00 KiB |
| jac313_store_007_XS | on | binary | 50 | 333,444 | 202.98 KiB |
|  |  | jtext | 50 | 335,683 | 179.40 KiB |
|  |  | sql | 50 | 402,739 | 248.00 KiB |
...
|  |  | jtext | 351 | - | 182.33 KiB |
|  |  | sql | 351 | - | 252.00 KiB |
| jac313_store_003_TS | on | binary | 401 | - | 202.98 KiB |
|  |  | jtext | 401 | - | 182.33 KiB |
|  |  | sql | 401 | - | 252.00 KiB |
...
| jac313_store_001_XS | store | matrix | sql | on | pass | 51 | - | 52.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_001_XS/clang_sql_on.log) |
...
| jac313_store_002_TS | store | matrix | jtext | on | pass | 51 | - | 20.59 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_002_TS/clang_jtext_on.log) |
...
| jac313_store_003_TS | store | matrix | binary | on | pass | 401 | - | 202.98 KiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_003_TS/clang_binary_on.log) |
...
| jac313_store_003_XS | store | matrix | jtext | on | pass | 401 | - | 179.40 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_003_XS/clang_jtext_on.log) |
...
| jac313_store_005_TS | store | matrix | binary | off | pass | 50 | 362,188 | 85.80 KiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_005_TS/clang_binary_off.log) |
...
| jac313_store_005_TS | store | matrix | jtext | off | pass | 50 | 363,769 | 76.72 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_TS/clang_jtext_off.log) |
| jac313_store_005_TS | store | matrix | jtext | on | pass | 50 | 327,976 | 76.73 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_TS/clang_jtext_on.log) |
| jac313_store_005_TS | store | matrix | none | off | pass | 50 | 669,344 | - | - | [clang_none_off.log](inmem_logs/JAC313_STORE_TEST_005_TS/clang_none_off.log) |
| jac313_store_005_TS | store | matrix | none | on | pass | 50 | 675,219 | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_005_TS/clang_none_on.log) |
| jac313_store_005_TS | store | matrix | sql | off | pass | 50 | 364,964 | 84.00 KiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_005_TS/clang_sql_off.log) |
| jac313_store_005_TS | store | matrix | sql | on | pass | 50 | 337,724 | 84.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_005_TS/clang_sql_on.log) |
| jac313_store_005_XS | store | matrix | binary | off | pass | 50 | 312,891 | 85.80 KiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_005_XS/clang_binary_off.log) |
| jac313_store_005_XS | store | matrix | binary | on | pass | 50 | 342,349 | 85.80 KiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_005_XS/clang_binary_on.log) |
| jac313_store_005_XS | store | matrix | jtext | off | pass | 50 | 348,432 | 73.80 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_XS/clang_jtext_off.log) |
| jac313_store_005_XS | store | matrix | jtext | on | pass | 50 | 344,828 | 73.80 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_XS/clang_jtext_on.log) |
| jac313_store_005_XS | store | matrix | none | off | pass | 50 | 617,665 | - | - | [clang_none_off.log](inmem_logs/JAC313_STORE_TEST_005_XS/clang_none_off.log) |
| jac313_store_005_XS | store | matrix | none | on | pass | 50 | 768,049 | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_005_XS/clang_none_on.log) |
| jac313_store_005_XS | store | matrix | sql | off | pass | 50 | 356,379 | 84.00 KiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_005_XS/clang_sql_off.log) |
| jac313_store_005_XS | store | matrix | sql | on | pass | 50 | 377,501 | 84.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_005_XS/clang_sql_on.log) |
...
| jac313_store_006_TS | store | matrix | none | on | pass | 401 | - | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_006_TS/clang_none_on.log) |
...
| jac313_store_006_TS | store | matrix | sql | on | pass | 401 | - | 252.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_006_TS/clang_sql_on.log) |
...
| jac313_store_007_TS | store | matrix | binary | off | pass | 50 | 341,997 | 202.98 KiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_007_TS/clang_binary_off.log) |
| jac313_store_007_TS | store | matrix | binary | on | pass | 50 | 340,020 | 202.98 KiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_007_TS/clang_binary_on.log) |
| jac313_store_007_TS | store | matrix | jtext | off | pass | 50 | 360,620 | 182.33 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_TS/clang_jtext_off.log) |
| jac313_store_007_TS | store | matrix | jtext | on | pass | 50 | 355,619 | 182.33 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_TS/clang_jtext_on.log) |
| jac313_store_007_TS | store | matrix | none | off | pass | 50 | 718,907 | - | - | [clang_none_off.log](inmem_logs/JAC313_STORE_TEST_007_TS/clang_none_off.log) |
| jac313_store_007_TS | store | matrix | none | on | pass | 50 | 763,942 | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_007_TS/clang_none_on.log) |
| jac313_store_007_TS | store | matrix | sql | off | pass | 50 | 322,373 | 252.00 KiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_007_TS/clang_sql_off.log) |
| jac313_store_007_TS | store | matrix | sql | on | pass | 50 | 378,931 | 252.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_007_TS/clang_sql_on.log) |
| jac313_store_007_XS | store | matrix | binary | off | pass | 50 | 351,124 | 202.98 KiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_007_XS/clang_binary_off.log) |
| jac313_store_007_XS | store | matrix | binary | on | pass | 50 | 333,444 | 202.98 KiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_007_XS/clang_binary_on.log) |
| jac313_store_007_XS | store | matrix | jtext | off | pass | 50 | 377,929 | 179.40 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_XS/clang_jtext_off.log) |
| jac313_store_007_XS | store | matrix | jtext | on | pass | 50 | 335,683 | 179.40 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_XS/clang_jtext_on.log) |
| jac313_store_007_XS | store | matrix | none | off | pass | 50 | 633,312 | - | - | [clang_none_off.log](inmem_logs/JAC313_STORE_TEST_007_XS/clang_none_off.log) |
| jac313_store_007_XS | store | matrix | none | on | pass | 50 | 700,771 | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_007_XS/clang_none_on.log) |
| jac313_store_007_XS | store | matrix | sql | off | pass | 50 | 363,769 | 248.00 KiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_007_XS/clang_sql_off.log) |
| jac313_store_007_XS | store | matrix | sql | on | pass | 50 | 402,739 | 248.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_007_XS/clang_sql_on.log) |
| jac313_store_008_TS | store | matrix | flags | off | pass | 50 | 335,121 | - | - | [clang_flags_off.log](flags_logs/JAC313_STORE_TEST_008_TS/clang_flags_off.log) |
| jac313_store_008_XS | store | matrix | flags | off | pass | 50 | 316,857 | - | - | [clang_flags_off.log](flags_logs/JAC313_STORE_TEST_008_XS/clang_flags_off.log) |
