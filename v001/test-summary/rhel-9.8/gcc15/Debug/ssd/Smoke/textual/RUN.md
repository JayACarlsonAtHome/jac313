...
|------|--------|---------|--------|--------------|----------|
| jac313_store_005_TS | off | binary | 50 | 1,146,789 | 85.80 KiB |
|  |  | jtext | 50 | 1,207,729 | 75.81 KiB |
|  |  | sql | 50 | 1,424,501 | 84.00 KiB |
| jac313_store_005_TS | on | binary | 50 | 1,322,751 | 85.80 KiB |
|  |  | jtext | 50 | 1,408,451 | 75.78 KiB |
|  |  | sql | 50 | 1,543,210 | 84.00 KiB |
| jac313_store_005_XS | off | binary | 50 | 1,117,318 | 85.80 KiB |
|  |  | jtext | 50 | 1,037,344 | 73.83 KiB |
|  |  | sql | 50 | 1,536,098 | 84.00 KiB |
| jac313_store_005_XS | on | binary | 50 | 1,592,357 | 85.80 KiB |
|  |  | jtext | 50 | 1,508,296 | 73.83 KiB |
|  |  | sql | 50 | 1,497,006 | 84.00 KiB |
| jac313_store_006_TS | off | binary | 351 | N/A | 202.99 KiB |
|  |  | jtext | 351 | N/A | 181.52 KiB |
|  |  | sql | 351 | N/A | 252.00 KiB |
| jac313_store_006_TS | on | binary | 401 | N/A | 202.99 KiB |
|  |  | jtext | 401 | N/A | 181.39 KiB |
...
| jac313_store_007_TS | off | binary | 50 | 1,157,407 | 202.99 KiB |
|  |  | jtext | 50 | 1,259,446 | 181.39 KiB |
|  |  | sql | 50 | 1,508,296 | 252.00 KiB |
| jac313_store_007_TS | on | binary | 50 | 1,037,344 | 202.99 KiB |
|  |  | jtext | 50 | 1,369,863 | 181.40 KiB |
|  |  | sql | 50 | 1,466,276 | 252.00 KiB |
| jac313_store_007_XS | off | binary | 50 | 1,464,129 | 202.99 KiB |
|  |  | jtext | 50 | 1,157,407 | 179.44 KiB |
|  |  | sql | 50 | 1,176,471 | 248.00 KiB |
| jac313_store_007_XS | on | binary | 50 | 1,466,276 | 202.99 KiB |
|  |  | jtext | 50 | 1,278,772 | 179.44 KiB |
|  |  | sql | 50 | 1,447,178 | 248.00 KiB |
...
| jac313_store_003_TS | store | matrix | jtext | on | pass | 401 | - | 181.51 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_003_TS/gcc15_jtext_on.log) |
...
| jac313_store_005_TS | store | matrix | binary | off | pass | 50 | 1,146,789 | 85.80 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_005_TS/gcc15_binary_off.log) |
| jac313_store_005_TS | store | matrix | binary | on | pass | 50 | 1,322,751 | 85.80 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_005_TS/gcc15_binary_on.log) |
| jac313_store_005_TS | store | matrix | jtext | off | pass | 50 | 1,207,729 | 75.81 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_TS/gcc15_jtext_off.log) |
| jac313_store_005_TS | store | matrix | jtext | on | pass | 50 | 1,408,451 | 75.78 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_TS/gcc15_jtext_on.log) |
| jac313_store_005_TS | store | matrix | none | off | pass | 50 | 2,695,418 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_005_TS/gcc15_none_off.log) |
| jac313_store_005_TS | store | matrix | none | on | pass | 50 | 2,386,635 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_005_TS/gcc15_none_on.log) |
...
| jac313_store_005_TS | store | matrix | sql | on | pass | 50 | 1,543,210 | 84.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_005_TS/gcc15_sql_on.log) |
| jac313_store_005_XS | store | matrix | binary | off | pass | 50 | 1,117,318 | 85.80 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_005_XS/gcc15_binary_off.log) |
| jac313_store_005_XS | store | matrix | binary | on | pass | 50 | 1,592,357 | 85.80 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_005_XS/gcc15_binary_on.log) |
| jac313_store_005_XS | store | matrix | jtext | off | pass | 50 | 1,037,344 | 73.83 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_XS/gcc15_jtext_off.log) |
| jac313_store_005_XS | store | matrix | jtext | on | pass | 50 | 1,508,296 | 73.83 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_XS/gcc15_jtext_on.log) |
| jac313_store_005_XS | store | matrix | none | off | pass | 50 | 1,760,563 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_005_XS/gcc15_none_off.log) |
| jac313_store_005_XS | store | matrix | none | on | pass | 50 | 2,816,901 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_005_XS/gcc15_none_on.log) |
| jac313_store_005_XS | store | matrix | sql | off | pass | 50 | 1,536,098 | 84.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_005_XS/gcc15_sql_off.log) |
| jac313_store_005_XS | store | matrix | sql | on | pass | 50 | 1,497,006 | 84.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_005_XS/gcc15_sql_on.log) |
...
| jac313_store_006_TS | store | matrix | jtext | off | pass | 351 | N/A | 181.52 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_006_TS/gcc15_jtext_off.log) |
| jac313_store_006_TS | store | matrix | jtext | on | pass | 401 | N/A | 181.39 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_006_TS/gcc15_jtext_on.log) |
...
| jac313_store_007_TS | store | matrix | binary | off | pass | 50 | 1,157,407 | 202.99 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_007_TS/gcc15_binary_off.log) |
| jac313_store_007_TS | store | matrix | binary | on | pass | 50 | 1,037,344 | 202.99 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_007_TS/gcc15_binary_on.log) |
| jac313_store_007_TS | store | matrix | jtext | off | pass | 50 | 1,259,446 | 181.39 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_TS/gcc15_jtext_off.log) |
| jac313_store_007_TS | store | matrix | jtext | on | pass | 50 | 1,369,863 | 181.40 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_TS/gcc15_jtext_on.log) |
| jac313_store_007_TS | store | matrix | none | off | pass | 50 | 2,624,672 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_007_TS/gcc15_none_off.log) |
| jac313_store_007_TS | store | matrix | none | on | pass | 50 | 2,164,502 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_007_TS/gcc15_none_on.log) |
...
| jac313_store_007_TS | store | matrix | sql | on | pass | 50 | 1,466,276 | 252.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_007_TS/gcc15_sql_on.log) |
...
| jac313_store_007_XS | store | matrix | binary | on | pass | 50 | 1,466,276 | 202.99 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_007_XS/gcc15_binary_on.log) |
| jac313_store_007_XS | store | matrix | jtext | off | pass | 50 | 1,157,407 | 179.44 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_XS/gcc15_jtext_off.log) |
| jac313_store_007_XS | store | matrix | jtext | on | pass | 50 | 1,278,772 | 179.44 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_XS/gcc15_jtext_on.log) |
| jac313_store_007_XS | store | matrix | none | off | pass | 50 | 3,225,806 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_007_XS/gcc15_none_off.log) |
| jac313_store_007_XS | store | matrix | none | on | pass | 50 | 2,816,901 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_007_XS/gcc15_none_on.log) |
| jac313_store_007_XS | store | matrix | sql | off | pass | 50 | 1,176,471 | 248.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_007_XS/gcc15_sql_off.log) |
| jac313_store_007_XS | store | matrix | sql | on | pass | 50 | 1,447,178 | 248.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_007_XS/gcc15_sql_on.log) |
| jac313_store_008_TS | store | matrix | flags | off | pass | 50 | 1,497,006 | - | - | [gcc15_flags_off.log](flags_logs/JAC313_STORE_TEST_008_TS/gcc15_flags_off.log) |
| jac313_store_008_XS | store | matrix | flags | off | pass | 50 | 1,438,849 | - | - | [gcc15_flags_off.log](flags_logs/JAC313_STORE_TEST_008_XS/gcc15_flags_off.log) |
