...
| Skipped | 0 |
| Errors | 0 |
| Duration | 603,647 ms (10m 3s) |
| Build straight (no modules) | 14,379 ms (14,379 ms (14s)) |
| Build modules only | 5,161 ms (5,161 ms (5s)) |
| Build with modules (rest) | 14,478 ms (14,478 ms (14s)) |
| Build modules only (import std) | 12,229 ms (12,229 ms (12s)) |
| Build with modules (import std) | 14,327 ms (14,327 ms (14s)) |
| import std vs textual modules | -151 ms (1% faster) |
| Peak ops/sec | 6,276,479 |
...
|------|--------|---------|--------|--------------|----------|
| jac313_store_005_TS | off | binary | 451 | 5,983,724 | 8.38 MiB |
|  |  | jtext | 1,403 | 5,110,384 | 7.91 MiB |
|  |  | sql | 401 | 6,188,119 | 7.42 MiB |
| jac313_store_005_TS | on | binary | 400 | 5,095,801 | 8.38 MiB |
|  |  | jtext | 1,403 | 5,235,602 | 7.91 MiB |
|  |  | sql | 501 | 5,915,410 | 7.42 MiB |
| jac313_store_005_XS | off | binary | 451 | 5,275,931 | 8.38 MiB |
|  |  | jtext | 1,402 | 5,170,096 | 7.44 MiB |
|  |  | sql | 451 | 5,210,233 | 7.13 MiB |
| jac313_store_005_XS | on | binary | 451 | 6,249,609 | 8.38 MiB |
|  |  | jtext | 1,353 | 5,438,625 | 7.44 MiB |
|  |  | sql | 501 | 6,200,012 | 7.13 MiB |
| jac313_store_006_TS | off | binary | 32,038 | - | 19.81 MiB |
|  |  | jtext | 32,332 | - | 20.40 MiB |
|  |  | sql | 32,141 | - | 23.48 MiB |
| jac313_store_006_TS | on | binary | 35,701 | - | 19.81 MiB |
|  |  | jtext | 35,949 | - | 20.40 MiB |
|  |  | sql | 35,849 | - | 23.48 MiB |
| jac313_store_006_XS | off | binary | 31,482 | - | 19.81 MiB |
|  |  | jtext | 31,733 | - | 19.96 MiB |
|  |  | sql | 31,531 | - | 22.64 MiB |
| jac313_store_006_XS | on | binary | 34,697 | - | 19.81 MiB |
|  |  | jtext | 35,348 | - | 19.96 MiB |
|  |  | sql | 34,900 | - | 22.64 MiB |
| jac313_store_007_TS | off | binary | 551 | 4,960,317 | 19.82 MiB |
|  |  | jtext | 3,959 | 4,869,497 | 20.44 MiB |
|  |  | sql | 852 | 5,286,530 | 23.51 MiB |
| jac313_store_007_TS | on | binary | 601 | 4,455,534 | 19.82 MiB |
|  |  | jtext | 4,360 | 5,541,701 | 20.44 MiB |
|  |  | sql | 952 | 5,100,219 | 23.51 MiB |
| jac313_store_007_XS | off | binary | 501 | 4,659,832 | 19.82 MiB |
|  |  | jtext | 4,109 | 5,499,038 | 19.98 MiB |
|  |  | sql | 902 | 5,829,884 | 22.66 MiB |
| jac313_store_007_XS | on | binary | 501 | 5,862,696 | 19.82 MiB |
|  |  | jtext | 3,808 | 4,745,859 | 19.98 MiB |
|  |  | sql | 1,102 | 5,694,112 | 22.66 MiB |
...
| jac313_store_002_TS | store | matrix | jtext | on | pass | 150 | - | 140.51 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_002_TS/gcc15_jtext_on.log) |
...
| jac313_store_003_XS | store | matrix | sql | on | pass | 553 | - | 352.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_003_XS/gcc15_sql_on.log) |
...
| jac313_store_005_TS | store | matrix | binary | off | pass | 451 | 5,983,724 | 8.38 MiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_005_TS/gcc15_binary_off.log) |
| jac313_store_005_TS | store | matrix | binary | on | pass | 400 | 5,095,801 | 8.38 MiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_005_TS/gcc15_binary_on.log) |
| jac313_store_005_TS | store | matrix | jtext | off | pass | 1,403 | 5,110,384 | 7.91 MiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_TS/gcc15_jtext_off.log) |
| jac313_store_005_TS | store | matrix | jtext | on | pass | 1,403 | 5,235,602 | 7.91 MiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_TS/gcc15_jtext_on.log) |
| jac313_store_005_TS | store | matrix | none | off | pass | 150 | 5,335,041 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_005_TS/gcc15_none_off.log) |
| jac313_store_005_TS | store | matrix | none | on | pass | 150 | 6,073,858 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_005_TS/gcc15_none_on.log) |
| jac313_store_005_TS | store | matrix | sql | off | pass | 401 | 6,188,119 | 7.42 MiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_005_TS/gcc15_sql_off.log) |
| jac313_store_005_TS | store | matrix | sql | on | pass | 501 | 5,915,410 | 7.42 MiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_005_TS/gcc15_sql_on.log) |
| jac313_store_005_XS | store | matrix | binary | off | pass | 451 | 5,275,931 | 8.38 MiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_005_XS/gcc15_binary_off.log) |
| jac313_store_005_XS | store | matrix | binary | on | pass | 451 | 6,249,609 | 8.38 MiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_005_XS/gcc15_binary_on.log) |
| jac313_store_005_XS | store | matrix | jtext | off | pass | 1,402 | 5,170,096 | 7.44 MiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_XS/gcc15_jtext_off.log) |
| jac313_store_005_XS | store | matrix | jtext | on | pass | 1,353 | 5,438,625 | 7.44 MiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_XS/gcc15_jtext_on.log) |
| jac313_store_005_XS | store | matrix | none | off | pass | 150 | 5,282,899 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_005_XS/gcc15_none_off.log) |
| jac313_store_005_XS | store | matrix | none | on | pass | 150 | 6,169,793 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_005_XS/gcc15_none_on.log) |
| jac313_store_005_XS | store | matrix | sql | off | pass | 451 | 5,210,233 | 7.13 MiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_005_XS/gcc15_sql_off.log) |
| jac313_store_005_XS | store | matrix | sql | on | pass | 501 | 6,200,012 | 7.13 MiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_005_XS/gcc15_sql_on.log) |
...
| jac313_store_006_TS | store | matrix | jtext | off | pass | 32,332 | - | 20.40 MiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_006_TS/gcc15_jtext_off.log) |
| jac313_store_006_TS | store | matrix | jtext | on | pass | 35,949 | - | 20.40 MiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_006_TS/gcc15_jtext_on.log) |
| jac313_store_006_TS | store | matrix | none | off | pass | 31,735 | - | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_006_TS/gcc15_none_off.log) |
...
| jac313_store_006_TS | store | matrix | sql | off | pass | 32,141 | - | 23.48 MiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_006_TS/gcc15_sql_off.log) |
| jac313_store_006_TS | store | matrix | sql | on | pass | 35,849 | - | 23.48 MiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_006_TS/gcc15_sql_on.log) |
| jac313_store_006_XS | store | matrix | binary | off | pass | 31,482 | - | 19.81 MiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_006_XS/gcc15_binary_off.log) |
...
| jac313_store_006_XS | store | matrix | jtext | off | pass | 31,733 | - | 19.96 MiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_006_XS/gcc15_jtext_off.log) |
| jac313_store_006_XS | store | matrix | jtext | on | pass | 35,348 | - | 19.96 MiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_006_XS/gcc15_jtext_on.log) |
| jac313_store_006_XS | store | matrix | none | off | pass | 31,135 | - | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_006_XS/gcc15_none_off.log) |
...
| jac313_store_006_XS | store | matrix | sql | on | pass | 34,900 | - | 22.64 MiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_006_XS/gcc15_sql_on.log) |
| jac313_store_007_TS | store | matrix | binary | off | pass | 551 | 4,960,317 | 19.82 MiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_007_TS/gcc15_binary_off.log) |
| jac313_store_007_TS | store | matrix | binary | on | pass | 601 | 4,455,534 | 19.82 MiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_007_TS/gcc15_binary_on.log) |
| jac313_store_007_TS | store | matrix | jtext | off | pass | 3,959 | 4,869,497 | 20.44 MiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_TS/gcc15_jtext_off.log) |
| jac313_store_007_TS | store | matrix | jtext | on | pass | 4,360 | 5,541,701 | 20.44 MiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_TS/gcc15_jtext_on.log) |
| jac313_store_007_TS | store | matrix | none | off | pass | 200 | 5,117,707 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_007_TS/gcc15_none_off.log) |
| jac313_store_007_TS | store | matrix | none | on | pass | 200 | 5,552,163 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_007_TS/gcc15_none_on.log) |
| jac313_store_007_TS | store | matrix | sql | off | pass | 852 | 5,286,530 | 23.51 MiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_007_TS/gcc15_sql_off.log) |
| jac313_store_007_TS | store | matrix | sql | on | pass | 952 | 5,100,219 | 23.51 MiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_007_TS/gcc15_sql_on.log) |
| jac313_store_007_XS | store | matrix | binary | off | pass | 501 | 4,659,832 | 19.82 MiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_007_XS/gcc15_binary_off.log) |
| jac313_store_007_XS | store | matrix | binary | on | pass | 501 | 5,862,696 | 19.82 MiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_007_XS/gcc15_binary_on.log) |
| jac313_store_007_XS | store | matrix | jtext | off | pass | 4,109 | 5,499,038 | 19.98 MiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_XS/gcc15_jtext_off.log) |
| jac313_store_007_XS | store | matrix | jtext | on | pass | 3,808 | 4,745,859 | 19.98 MiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_XS/gcc15_jtext_on.log) |
| jac313_store_007_XS | store | matrix | none | off | pass | 200 | 5,843,169 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_007_XS/gcc15_none_off.log) |
| jac313_store_007_XS | store | matrix | none | on | pass | 200 | 5,743,825 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_007_XS/gcc15_none_on.log) |
| jac313_store_007_XS | store | matrix | sql | off | pass | 902 | 5,829,884 | 22.66 MiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_007_XS/gcc15_sql_off.log) |
| jac313_store_007_XS | store | matrix | sql | on | pass | 1,102 | 5,694,112 | 22.66 MiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_007_XS/gcc15_sql_on.log) |
| jac313_store_008_TS | store | matrix | flags | off | pass | 5,510 | 6,276,479 | - | - | [gcc15_flags_off.log](flags_logs/JAC313_STORE_TEST_008_TS/gcc15_flags_off.log) |
| jac313_store_008_XS | store | matrix | flags | off | pass | 5,811 | 5,195,939 | - | - | [gcc15_flags_off.log](flags_logs/JAC313_STORE_TEST_008_XS/gcc15_flags_off.log) |
