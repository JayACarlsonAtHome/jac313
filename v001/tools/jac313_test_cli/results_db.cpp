...
const PkgSource kPkgSources[] = {
    {"jac313::Qlite::v001", "Qlite/include/jac313/Qlite/v001/Sqlite.body.hpp", 0},
    {"jac313::jText::v001", "jText/jText.api.inc", 1},
    {"jac313::Store::v001", "Store/include/jac313/Store/v001/headers/ts_store_config.hpp", 2},
};
...
std::string read_version_literal(const fs::path& file) {
    ...
    while (std::getline(in, line)) {
        ...
        return line.substr(q1 + 1, q2 - q1 - 1);  // e.g. "v001.001"
    }
    return {};
}
