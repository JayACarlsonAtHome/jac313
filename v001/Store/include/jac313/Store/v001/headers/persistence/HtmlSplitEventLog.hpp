...
// HtmlSplitEventLog
// Browser-viewable 3-file split persistence (main + _Ints + _Floats).
...
class HtmlSplitEventLog {
public:
    HtmlSplitEventLog(std::string_view base_name,
                      size_t int_count,
                      size_t dbl_count,
    ...
    HtmlSplitEventLog(HtmlSplitEventLog&&) noexcept;
    HtmlSplitEventLog& operator=(HtmlSplitEventLog&&) noexcept;
    ...
    [[nodiscard]] const HtmlSplitEventLogStats& stats() const;
