...
// of jac313::Store::v001::). Covers the core store (ts_store, ts_store_config,
...
int main() {
    ...
    (void)sizeof(jac313::Store::v001::PersistedEvent);
    (void)sizeof(jac313::Store::v001::BinaryRecord);
    (void)sizeof(jac313::Store::v001::BinaryEventLogReader);
    (void)sizeof(jac313::Store::v001::SqlEventSink);
    (void)sizeof(jac313::Store::v001::SqliteError);

    const jac313::Store::v001::PersistMode pm = jac313::Store::v001::PersistMode::All;
    return (pm == jac313::Store::v001::PersistMode::All) ? EXIT_SUCCESS : EXIT_FAILURE;
}
