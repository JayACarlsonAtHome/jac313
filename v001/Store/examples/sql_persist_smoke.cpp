...
int main() {
    ...
    auto sink = std::make_unique<jac313::Store::v001::SqlEventSink>(
        out.string(), 2, 2, jac313::Store::v001::PersistMode::All, true);
    ...
    std::cout << "jac313::Store::v001 SQLite persistence smoke OK\n";
    return EXIT_SUCCESS;
}