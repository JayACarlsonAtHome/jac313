...
| Build with modules (rest) | 6,611 ms (6,611 ms (6s)) |
| Build modules only (import std) | 4,362 ms (4,362 ms (4s)) |
| Build with modules (import std) | 7,163 ms (7,163 ms (7s)) |
| import std vs textual modules | +552 ms (-8% slower) |
| Peak ops/sec | 3,436,426 |
...
|------|--------|---------|--------|--------------|----------|
| jac313_store_005_TS | off | binary | 50 | 1,394,700 | 85.80 KiB |
|  |  | jtext | 50 | 1,479,290 | 75.78 KiB |
|  |  | sql | 50 | 1,424,501 | 84.00 KiB |
| jac313_store_005_TS | on | binary | 50 | 1,386,963 | 85.80 KiB |
|  |  | jtext | 50 | 1,472,754 | 75.78 KiB |
|  |  | sql | 50 | 1,404,494 | 84.00 KiB |
| jac313_store_005_XS | off | binary | 50 | 1,394,700 | 85.80 KiB |
|  |  | jtext | 50 | 1,501,502 | 73.83 KiB |
|  |  | sql | 50 | 1,669,449 | 84.00 KiB |
| jac313_store_005_XS | on | binary | 50 | 1,557,632 | 85.80 KiB |
|  |  | jtext | 50 | 1,226,994 | 73.83 KiB |
|  |  | sql | 50 | 1,483,680 | 84.00 KiB |
| jac313_store_006_TS | off | binary | 351 | N/A | 202.99 KiB |
|  |  | jtext | 351 | N/A | 181.58 KiB |
|  |  | sql | 351 | N/A | 252.00 KiB |
| jac313_store_006_TS | on | binary | 401 | N/A | 202.99 KiB |
|  |  | jtext | 401 | N/A | 181.52 KiB |
...
| jac313_store_007_TS | off | binary | 50 | 1,474,926 | 202.99 KiB |
|  |  | jtext | 50 | 1,119,821 | 181.62 KiB |
|  |  | sql | 50 | 1,508,296 | 252.00 KiB |
| jac313_store_007_TS | on | binary | 50 | 840,336 | 202.99 KiB |
|  |  | jtext | 50 | 1,349,528 | 181.49 KiB |
|  |  | sql | 50 | 1,317,523 | 252.00 KiB |
| jac313_store_007_XS | off | binary | 50 | 1,414,427 | 202.99 KiB |
|  |  | jtext | 50 | 1,524,390 | 179.44 KiB |
|  |  | sql | 50 | 1,506,024 | 248.00 KiB |
| jac313_store_007_XS | on | binary | 50 | 1,552,795 | 202.99 KiB |
|  |  | jtext | 50 | 1,336,898 | 179.44 KiB |
|  |  | sql | 50 | 1,342,282 | 248.00 KiB |
...
| jac313_store_003_TS | store | matrix | jtext | off | pass | 351 | - | 181.51 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_003_TS/gcc15_jtext_off.log) |
...
| jac313_store_005_TS | store | matrix | binary | off | pass | 50 | 1,394,700 | 85.80 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_005_TS/gcc15_binary_off.log) |
| jac313_store_005_TS | store | matrix | binary | on | pass | 50 | 1,386,963 | 85.80 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_005_TS/gcc15_binary_on.log) |
| jac313_store_005_TS | store | matrix | jtext | off | pass | 50 | 1,479,290 | 75.78 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_TS/gcc15_jtext_off.log) |
| jac313_store_005_TS | store | matrix | jtext | on | pass | 50 | 1,472,754 | 75.78 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_TS/gcc15_jtext_on.log) |
| jac313_store_005_TS | store | matrix | none | off | pass | 50 | 2,358,491 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_005_TS/gcc15_none_off.log) |
| jac313_store_005_TS | store | matrix | none | on | pass | 50 | 3,436,426 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_005_TS/gcc15_none_on.log) |
| jac313_store_005_TS | store | matrix | sql | off | pass | 50 | 1,424,501 | 84.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_005_TS/gcc15_sql_off.log) |
| jac313_store_005_TS | store | matrix | sql | on | pass | 50 | 1,404,494 | 84.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_005_TS/gcc15_sql_on.log) |
| jac313_store_005_XS | store | matrix | binary | off | pass | 50 | 1,394,700 | 85.80 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_005_XS/gcc15_binary_off.log) |
| jac313_store_005_XS | store | matrix | binary | on | pass | 50 | 1,557,632 | 85.80 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_005_XS/gcc15_binary_on.log) |
| jac313_store_005_XS | store | matrix | jtext | off | pass | 50 | 1,501,502 | 73.83 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_XS/gcc15_jtext_off.log) |
| jac313_store_005_XS | store | matrix | jtext | on | pass | 50 | 1,226,994 | 73.83 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_XS/gcc15_jtext_on.log) |
| jac313_store_005_XS | store | matrix | none | off | pass | 50 | 2,283,105 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_005_XS/gcc15_none_off.log) |
| jac313_store_005_XS | store | matrix | none | on | pass | 50 | 1,996,008 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_005_XS/gcc15_none_on.log) |
| jac313_store_005_XS | store | matrix | sql | off | pass | 50 | 1,669,449 | 84.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_005_XS/gcc15_sql_off.log) |
| jac313_store_005_XS | store | matrix | sql | on | pass | 50 | 1,483,680 | 84.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_005_XS/gcc15_sql_on.log) |
...
| jac313_store_006_TS | store | matrix | jtext | off | pass | 351 | N/A | 181.58 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_006_TS/gcc15_jtext_off.log) |
| jac313_store_006_TS | store | matrix | jtext | on | pass | 401 | N/A | 181.52 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_006_TS/gcc15_jtext_on.log) |
...
| jac313_store_007_TS | store | matrix | binary | off | pass | 50 | 1,474,926 | 202.99 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_007_TS/gcc15_binary_off.log) |
| jac313_store_007_TS | store | matrix | binary | on | pass | 50 | 840,336 | 202.99 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_007_TS/gcc15_binary_on.log) |
| jac313_store_007_TS | store | matrix | jtext | off | pass | 50 | 1,119,821 | 181.62 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_TS/gcc15_jtext_off.log) |
| jac313_store_007_TS | store | matrix | jtext | on | pass | 50 | 1,349,528 | 181.49 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_TS/gcc15_jtext_on.log) |
| jac313_store_007_TS | store | matrix | none | off | pass | 50 | 2,341,920 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_007_TS/gcc15_none_off.log) |
| jac313_store_007_TS | store | matrix | none | on | pass | 50 | 3,257,329 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_007_TS/gcc15_none_on.log) |
| jac313_store_007_TS | store | matrix | sql | off | pass | 50 | 1,508,296 | 252.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_007_TS/gcc15_sql_off.log) |
| jac313_store_007_TS | store | matrix | sql | on | pass | 50 | 1,317,523 | 252.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_007_TS/gcc15_sql_on.log) |
| jac313_store_007_XS | store | matrix | binary | off | pass | 50 | 1,414,427 | 202.99 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_007_XS/gcc15_binary_off.log) |
| jac313_store_007_XS | store | matrix | binary | on | pass | 50 | 1,552,795 | 202.99 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_007_XS/gcc15_binary_on.log) |
| jac313_store_007_XS | store | matrix | jtext | off | pass | 50 | 1,524,390 | 179.44 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_XS/gcc15_jtext_off.log) |
| jac313_store_007_XS | store | matrix | jtext | on | pass | 50 | 1,336,898 | 179.44 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_XS/gcc15_jtext_on.log) |
| jac313_store_007_XS | store | matrix | none | off | pass | 50 | 2,427,184 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_007_XS/gcc15_none_off.log) |
| jac313_store_007_XS | store | matrix | none | on | pass | 50 | 2,583,979 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_007_XS/gcc15_none_on.log) |
| jac313_store_007_XS | store | matrix | sql | off | pass | 50 | 1,506,024 | 248.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_007_XS/gcc15_sql_off.log) |
| jac313_store_007_XS | store | matrix | sql | on | pass | 50 | 1,342,282 | 248.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_007_XS/gcc15_sql_on.log) |
| jac313_store_008_TS | store | matrix | flags | off | pass | 50 | 1,351,351 | - | - | [gcc15_flags_off.log](flags_logs/JAC313_STORE_TEST_008_TS/gcc15_flags_off.log) |
| jac313_store_008_XS | store | matrix | flags | off | pass | 50 | 1,592,357 | - | - | [gcc15_flags_off.log](flags_logs/JAC313_STORE_TEST_008_XS/gcc15_flags_off.log) |
