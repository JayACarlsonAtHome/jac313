...
| Skipped | 0 |
| Errors | 0 |
| Duration | 16,034 ms (16s) |
| Peak ops/sec | 4,032,258 |
...
|------|--------|---------|--------|--------------|----------|
| jac313_store_005_TS | off | binary | 50 | 2,197,802 | 85.80 KiB |
|  |  | jtext | 50 | 2,493,766 | 75.80 KiB |
|  |  | sql | 50 | 2,392,344 | 84.00 KiB |
| jac313_store_005_TS | on | binary | 50 | 2,109,705 | 85.80 KiB |
|  |  | jtext | 50 | 1,547,988 | 75.80 KiB |
|  |  | sql | 50 | 2,469,136 | 84.00 KiB |
| jac313_store_005_XS | off | binary | 50 | 2,638,522 | 85.80 KiB |
|  |  | jtext | 50 | 2,638,522 | 73.84 KiB |
|  |  | sql | 50 | 2,375,297 | 84.00 KiB |
| jac313_store_005_XS | on | binary | 50 | 1,745,201 | 85.80 KiB |
|  |  | jtext | 50 | 2,739,726 | 73.84 KiB |
|  |  | sql | 50 | 1,996,008 | 84.00 KiB |
...
|  |  | jtext | 401 | N/A | 181.51 KiB |
|  |  | sql | 401 | N/A | 252.00 KiB |
| jac313_store_006_XS | off | binary | 351 | N/A | 202.99 KiB |
|  |  | jtext | 301 | N/A | 179.46 KiB |
|  |  | sql | 351 | N/A | 248.00 KiB |
| jac313_store_006_XS | on | binary | 351 | N/A | 202.99 KiB |
|  |  | jtext | 401 | N/A | 179.46 KiB |
|  |  | sql | 402 | N/A | 248.00 KiB |
| jac313_store_007_TS | off | binary | 50 | 1,769,912 | 202.99 KiB |
|  |  | jtext | 50 | 1,492,537 | 181.41 KiB |
|  |  | sql | 50 | 2,123,142 | 252.00 KiB |
| jac313_store_007_TS | on | binary | 50 | 1,145,475 | 202.99 KiB |
|  |  | jtext | 50 | 2,277,904 | 181.41 KiB |
|  |  | sql | 50 | 2,392,344 | 252.00 KiB |
| jac313_store_007_XS | off | binary | 50 | 2,421,308 | 202.99 KiB |
|  |  | jtext | 50 | 2,079,002 | 179.46 KiB |
|  |  | sql | 50 | 1,848,429 | 248.00 KiB |
| jac313_store_007_XS | on | binary | 50 | 1,742,160 | 202.99 KiB |
|  |  | jtext | 50 | 2,604,167 | 179.46 KiB |
|  |  | sql | 50 | 2,283,105 | 248.00 KiB |
...
| jac313_store_005_TS | store | matrix | binary | off | pass | 50 | 2,197,802 | 85.80 KiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_005_TS/clang_binary_off.log) |
| jac313_store_005_TS | store | matrix | binary | on | pass | 50 | 2,109,705 | 85.80 KiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_005_TS/clang_binary_on.log) |
| jac313_store_005_TS | store | matrix | jtext | off | pass | 50 | 2,493,766 | 75.80 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_TS/clang_jtext_off.log) |
| jac313_store_005_TS | store | matrix | jtext | on | pass | 50 | 1,547,988 | 75.80 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_TS/clang_jtext_on.log) |
| jac313_store_005_TS | store | matrix | none | off | pass | 50 | 2,754,821 | - | - | [clang_none_off.log](inmem_logs/JAC313_STORE_TEST_005_TS/clang_none_off.log) |
| jac313_store_005_TS | store | matrix | none | on | pass | 50 | 4,032,258 | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_005_TS/clang_none_on.log) |
| jac313_store_005_TS | store | matrix | sql | off | pass | 50 | 2,392,344 | 84.00 KiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_005_TS/clang_sql_off.log) |
| jac313_store_005_TS | store | matrix | sql | on | pass | 50 | 2,469,136 | 84.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_005_TS/clang_sql_on.log) |
| jac313_store_005_XS | store | matrix | binary | off | pass | 50 | 2,638,522 | 85.80 KiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_005_XS/clang_binary_off.log) |
| jac313_store_005_XS | store | matrix | binary | on | pass | 50 | 1,745,201 | 85.80 KiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_005_XS/clang_binary_on.log) |
| jac313_store_005_XS | store | matrix | jtext | off | pass | 50 | 2,638,522 | 73.84 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_XS/clang_jtext_off.log) |
| jac313_store_005_XS | store | matrix | jtext | on | pass | 50 | 2,739,726 | 73.84 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_XS/clang_jtext_on.log) |
| jac313_store_005_XS | store | matrix | none | off | pass | 50 | 2,659,574 | - | - | [clang_none_off.log](inmem_logs/JAC313_STORE_TEST_005_XS/clang_none_off.log) |
| jac313_store_005_XS | store | matrix | none | on | pass | 50 | 1,779,359 | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_005_XS/clang_none_on.log) |
| jac313_store_005_XS | store | matrix | sql | off | pass | 50 | 2,375,297 | 84.00 KiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_005_XS/clang_sql_off.log) |
| jac313_store_005_XS | store | matrix | sql | on | pass | 50 | 1,996,008 | 84.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_005_XS/clang_sql_on.log) |
...
| jac313_store_006_TS | store | matrix | jtext | on | pass | 401 | N/A | 181.51 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_006_TS/clang_jtext_on.log) |
...
| jac313_store_006_XS | store | matrix | jtext | off | pass | 301 | N/A | 179.46 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_006_XS/clang_jtext_off.log) |
...
| jac313_store_006_XS | store | matrix | sql | on | pass | 402 | N/A | 248.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_006_XS/clang_sql_on.log) |
| jac313_store_007_TS | store | matrix | binary | off | pass | 50 | 1,769,912 | 202.99 KiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_007_TS/clang_binary_off.log) |
| jac313_store_007_TS | store | matrix | binary | on | pass | 50 | 1,145,475 | 202.99 KiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_007_TS/clang_binary_on.log) |
| jac313_store_007_TS | store | matrix | jtext | off | pass | 50 | 1,492,537 | 181.41 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_TS/clang_jtext_off.log) |
| jac313_store_007_TS | store | matrix | jtext | on | pass | 50 | 2,277,904 | 181.41 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_TS/clang_jtext_on.log) |
| jac313_store_007_TS | store | matrix | none | off | pass | 50 | 3,095,975 | - | - | [clang_none_off.log](inmem_logs/JAC313_STORE_TEST_007_TS/clang_none_off.log) |
| jac313_store_007_TS | store | matrix | none | on | pass | 50 | 3,115,265 | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_007_TS/clang_none_on.log) |
| jac313_store_007_TS | store | matrix | sql | off | pass | 50 | 2,123,142 | 252.00 KiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_007_TS/clang_sql_off.log) |
| jac313_store_007_TS | store | matrix | sql | on | pass | 50 | 2,392,344 | 252.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_007_TS/clang_sql_on.log) |
| jac313_store_007_XS | store | matrix | binary | off | pass | 50 | 2,421,308 | 202.99 KiB | - | [clang_binary_off.log](binary_logs/JAC313_STORE_TEST_007_XS/clang_binary_off.log) |
| jac313_store_007_XS | store | matrix | binary | on | pass | 50 | 1,742,160 | 202.99 KiB | - | [clang_binary_on.log](binary_logs/JAC313_STORE_TEST_007_XS/clang_binary_on.log) |
| jac313_store_007_XS | store | matrix | jtext | off | pass | 50 | 2,079,002 | 179.46 KiB | - | [clang_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_XS/clang_jtext_off.log) |
| jac313_store_007_XS | store | matrix | jtext | on | pass | 50 | 2,604,167 | 179.46 KiB | - | [clang_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_XS/clang_jtext_on.log) |
| jac313_store_007_XS | store | matrix | none | off | pass | 50 | 3,984,064 | - | - | [clang_none_off.log](inmem_logs/JAC313_STORE_TEST_007_XS/clang_none_off.log) |
| jac313_store_007_XS | store | matrix | none | on | pass | 50 | 2,702,703 | - | - | [clang_none_on.log](inmem_logs/JAC313_STORE_TEST_007_XS/clang_none_on.log) |
| jac313_store_007_XS | store | matrix | sql | off | pass | 50 | 1,848,429 | 248.00 KiB | - | [clang_sql_off.log](sql_logs/JAC313_STORE_TEST_007_XS/clang_sql_off.log) |
| jac313_store_007_XS | store | matrix | sql | on | pass | 50 | 2,283,105 | 248.00 KiB | - | [clang_sql_on.log](sql_logs/JAC313_STORE_TEST_007_XS/clang_sql_on.log) |
| jac313_store_008_TS | store | matrix | flags | off | pass | 50 | 2,079,002 | - | - | [clang_flags_off.log](flags_logs/JAC313_STORE_TEST_008_TS/clang_flags_off.log) |
| jac313_store_008_XS | store | matrix | flags | off | pass | 50 | 1,848,429 | - | - | [clang_flags_off.log](flags_logs/JAC313_STORE_TEST_008_XS/clang_flags_off.log) |
