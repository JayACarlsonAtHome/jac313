...
| Skipped | 0 |
| Errors | 0 |
| Duration | 17,987 ms (17s) |
| Build straight (no modules) | 15,989 ms (15,989 ms (15s)) |
| Build modules only | 1,553 ms (1,553 ms (1s)) |
| Build with modules (rest) | 16,841 ms (16,841 ms (16s)) |
| Build modules only (import std) | 5,963 ms (5,963 ms (5s)) |
| Build with modules (import std) | 16,996 ms (16,996 ms (16s)) |
| import std vs textual modules | +155 ms (0% slower) |
| Peak ops/sec | 2,439,024 |
...
|------|--------|---------|--------|--------------|----------|
| jac313_store_005_TS | off | binary | 100 | 844,595 | 85.80 KiB |
|  |  | jtext | 50 | 775,194 | 76.00 KiB |
|  |  | sql | 50 | 1,012,146 | 84.00 KiB |
| jac313_store_005_TS | on | binary | 100 | 1,257,862 | 85.80 KiB |
|  |  | jtext | 50 | 1,008,065 | 75.88 KiB |
|  |  | sql | 50 | 1,373,626 | 84.00 KiB |
| jac313_store_005_XS | off | binary | 100 | 1,126,126 | 85.80 KiB |
|  |  | jtext | 50 | 723,066 | 73.85 KiB |
|  |  | sql | 50 | 809,717 | 84.00 KiB |
| jac313_store_005_XS | on | binary | 100 | 914,077 | 85.80 KiB |
|  |  | jtext | 50 | 823,045 | 73.85 KiB |
|  |  | sql | 50 | 1,098,901 | 84.00 KiB |
| jac313_store_006_TS | off | binary | 401 | N/A | 202.99 KiB |
|  |  | jtext | 351 | N/A | 181.62 KiB |
|  |  | sql | 351 | N/A | 256.00 KiB |
| jac313_store_006_TS | on | binary | 502 | N/A | 202.99 KiB |
|  |  | jtext | 401 | N/A | 181.71 KiB |
...
|  |  | jtext | 401 | N/A | 179.47 KiB |
|  |  | sql | 401 | N/A | 248.00 KiB |
| jac313_store_007_TS | off | binary | 100 | 885,740 | 202.99 KiB |
|  |  | jtext | 50 | 1,091,703 | 181.42 KiB |
|  |  | sql | 50 | 1,059,322 | 256.00 KiB |
| jac313_store_007_TS | on | binary | 100 | 1,019,368 | 202.99 KiB |
|  |  | jtext | 50 | 1,275,510 | 181.51 KiB |
|  |  | sql | 50 | 1,287,001 | 256.00 KiB |
| jac313_store_007_XS | off | binary | 100 | 775,795 | 202.99 KiB |
|  |  | jtext | 50 | 1,261,034 | 179.47 KiB |
|  |  | sql | 50 | 1,076,426 | 248.00 KiB |
| jac313_store_007_XS | on | binary | 100 | 1,658,375 | 202.99 KiB |
|  |  | jtext | 50 | 1,400,560 | 179.47 KiB |
|  |  | sql | 50 | 1,261,034 | 248.00 KiB |
...
|  |  | jtext | 50 | - | 20.40 KiB |
|  |  | sql | 50 | - | 52.00 KiB |
| jac313_store_004_XS | on | binary | 200 | - | 20.40 KiB |
|  |  | jtext | 50 | - | 20.40 KiB |
|  |  | sql | 50 | - | 52.00 KiB |
| jac313_store_005_TS | off | binary | 100 | 844,595 | 85.80 KiB |
|  |  | jtext | 50 | 775,194 | 76.00 KiB |
...
| jac313_store_003_TS | store | matrix | binary | on | pass | 451 | - | 202.99 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_003_TS/gcc15_binary_on.log) |
| jac313_store_003_TS | store | matrix | jtext | off | pass | 351 | - | 181.42 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_003_TS/gcc15_jtext_off.log) |
| jac313_store_003_TS | store | matrix | jtext | on | pass | 402 | - | 181.81 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_003_TS/gcc15_jtext_on.log) |
...
| jac313_store_003_TS | store | matrix | sql | off | pass | 351 | - | 260.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_003_TS/gcc15_sql_off.log) |
| jac313_store_003_TS | store | matrix | sql | on | pass | 401 | - | 260.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_003_TS/gcc15_sql_on.log) |
...
| jac313_store_004_XS | store | matrix | binary | on | pass | 200 | - | 20.40 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_004_XS/gcc15_binary_on.log) |
...
| jac313_store_005_TS | store | matrix | binary | off | pass | 100 | 844,595 | 85.80 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_005_TS/gcc15_binary_off.log) |
| jac313_store_005_TS | store | matrix | binary | on | pass | 100 | 1,257,862 | 85.80 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_005_TS/gcc15_binary_on.log) |
| jac313_store_005_TS | store | matrix | jtext | off | pass | 50 | 775,194 | 76.00 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_TS/gcc15_jtext_off.log) |
| jac313_store_005_TS | store | matrix | jtext | on | pass | 50 | 1,008,065 | 75.88 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_TS/gcc15_jtext_on.log) |
| jac313_store_005_TS | store | matrix | none | off | pass | 50 | 1,730,104 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_005_TS/gcc15_none_off.log) |
| jac313_store_005_TS | store | matrix | none | on | pass | 50 | 1,497,006 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_005_TS/gcc15_none_on.log) |
| jac313_store_005_TS | store | matrix | sql | off | pass | 50 | 1,012,146 | 84.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_005_TS/gcc15_sql_off.log) |
| jac313_store_005_TS | store | matrix | sql | on | pass | 50 | 1,373,626 | 84.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_005_TS/gcc15_sql_on.log) |
| jac313_store_005_XS | store | matrix | binary | off | pass | 100 | 1,126,126 | 85.80 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_005_XS/gcc15_binary_off.log) |
| jac313_store_005_XS | store | matrix | binary | on | pass | 100 | 914,077 | 85.80 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_005_XS/gcc15_binary_on.log) |
| jac313_store_005_XS | store | matrix | jtext | off | pass | 50 | 723,066 | 73.85 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_005_XS/gcc15_jtext_off.log) |
| jac313_store_005_XS | store | matrix | jtext | on | pass | 50 | 823,045 | 73.85 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_005_XS/gcc15_jtext_on.log) |
| jac313_store_005_XS | store | matrix | none | off | pass | 50 | 990,099 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_005_XS/gcc15_none_off.log) |
| jac313_store_005_XS | store | matrix | none | on | pass | 50 | 2,314,815 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_005_XS/gcc15_none_on.log) |
| jac313_store_005_XS | store | matrix | sql | off | pass | 50 | 809,717 | 84.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_005_XS/gcc15_sql_off.log) |
| jac313_store_005_XS | store | matrix | sql | on | pass | 50 | 1,098,901 | 84.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_005_XS/gcc15_sql_on.log) |
...
| jac313_store_006_TS | store | matrix | binary | on | pass | 502 | N/A | 202.99 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_006_TS/gcc15_binary_on.log) |
| jac313_store_006_TS | store | matrix | jtext | off | pass | 351 | N/A | 181.62 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_006_TS/gcc15_jtext_off.log) |
| jac313_store_006_TS | store | matrix | jtext | on | pass | 401 | N/A | 181.71 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_006_TS/gcc15_jtext_on.log) |
...
| jac313_store_006_XS | store | matrix | jtext | on | pass | 401 | N/A | 179.47 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_006_XS/gcc15_jtext_on.log) |
...
| jac313_store_007_TS | store | matrix | binary | off | pass | 100 | 885,740 | 202.99 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_007_TS/gcc15_binary_off.log) |
| jac313_store_007_TS | store | matrix | binary | on | pass | 100 | 1,019,368 | 202.99 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_007_TS/gcc15_binary_on.log) |
| jac313_store_007_TS | store | matrix | jtext | off | pass | 50 | 1,091,703 | 181.42 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_TS/gcc15_jtext_off.log) |
| jac313_store_007_TS | store | matrix | jtext | on | pass | 50 | 1,275,510 | 181.51 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_TS/gcc15_jtext_on.log) |
| jac313_store_007_TS | store | matrix | none | off | pass | 50 | 2,415,459 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_007_TS/gcc15_none_off.log) |
| jac313_store_007_TS | store | matrix | none | on | pass | 50 | 1,821,494 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_007_TS/gcc15_none_on.log) |
| jac313_store_007_TS | store | matrix | sql | off | pass | 50 | 1,059,322 | 256.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_007_TS/gcc15_sql_off.log) |
| jac313_store_007_TS | store | matrix | sql | on | pass | 50 | 1,287,001 | 256.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_007_TS/gcc15_sql_on.log) |
| jac313_store_007_XS | store | matrix | binary | off | pass | 100 | 775,795 | 202.99 KiB | - | [gcc15_binary_off.log](binary_logs/JAC313_STORE_TEST_007_XS/gcc15_binary_off.log) |
| jac313_store_007_XS | store | matrix | binary | on | pass | 100 | 1,658,375 | 202.99 KiB | - | [gcc15_binary_on.log](binary_logs/JAC313_STORE_TEST_007_XS/gcc15_binary_on.log) |
| jac313_store_007_XS | store | matrix | jtext | off | pass | 50 | 1,261,034 | 179.47 KiB | - | [gcc15_jtext_off.log](jText_logs/JAC313_STORE_TEST_007_XS/gcc15_jtext_off.log) |
| jac313_store_007_XS | store | matrix | jtext | on | pass | 50 | 1,400,560 | 179.47 KiB | - | [gcc15_jtext_on.log](jText_logs/JAC313_STORE_TEST_007_XS/gcc15_jtext_on.log) |
| jac313_store_007_XS | store | matrix | none | off | pass | 50 | 1,297,017 | - | - | [gcc15_none_off.log](inmem_logs/JAC313_STORE_TEST_007_XS/gcc15_none_off.log) |
| jac313_store_007_XS | store | matrix | none | on | pass | 50 | 2,439,024 | - | - | [gcc15_none_on.log](inmem_logs/JAC313_STORE_TEST_007_XS/gcc15_none_on.log) |
| jac313_store_007_XS | store | matrix | sql | off | pass | 50 | 1,076,426 | 248.00 KiB | - | [gcc15_sql_off.log](sql_logs/JAC313_STORE_TEST_007_XS/gcc15_sql_off.log) |
| jac313_store_007_XS | store | matrix | sql | on | pass | 50 | 1,261,034 | 248.00 KiB | - | [gcc15_sql_on.log](sql_logs/JAC313_STORE_TEST_007_XS/gcc15_sql_on.log) |
| jac313_store_008_TS | store | matrix | flags | off | pass | 150 | 1,245,330 | - | - | [gcc15_flags_off.log](flags_logs/JAC313_STORE_TEST_008_TS/gcc15_flags_off.log) |
| jac313_store_008_XS | store | matrix | flags | off | pass | 300 | 979,432 | - | - | [gcc15_flags_off.log](flags_logs/JAC313_STORE_TEST_008_XS/gcc15_flags_off.log) |
