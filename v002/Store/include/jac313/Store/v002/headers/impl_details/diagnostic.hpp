...
inline void diagnose_failures(size_t max_report = std::numeric_limits<size_t>::max()) const
{
    ...
    if (failures.empty()) {
        ...
        jac313_rt_print("{}{:^{}}{}",ansi::bold_green(), msg, box_width, ansi::reset());
        std::print("{}╚═══════════════════════════════════════════════════════════════════════════════╝{}",ansi::bold_green(), ansi::reset());
        ...
        jac313_rt_print("{}{:^{}}{}",ansi::bold_red(), header, box_width, ansi::reset());
        jac313_rt_print("{}{:^{}}{}",ansi::bold_red(), report, box_width, ansi::reset());
        std::print("{}╚═══════════════════════════════════════════════════════════════════════════════╝{}",ansi::bold_red(), ansi::reset());
    }
}