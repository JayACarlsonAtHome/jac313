// Module-native jac313.store.v002 — `import std;` front-end (gcc pilot, opt-in via
...
// textual std includes + its `namespace jac313::Store::v002` wrapper, so the bodies paste
...
#include <jac313/Store/v002/headers/persistence/BinaryEventLogReader.cpp>
#include <jac313/Store/v002/headers/persistence/SqlEventSink.cpp>
#include <jac313/Store/v002/headers/persistence/JTextSplitEventLog.cpp>
#include <jac313/Store/v002/headers/persistence/BinaryEventLogReader_jtext.cpp>
}
